        ...
        >
          <a href="#top" className="flex items-center gap-2">
            <div className="relative h-7 w-7">
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-purple-500 to-sky-400 blur-sm opacity-70" />
              <div className="relative flex h-full w-full items-center justify-center rounded-2xl bg-slate-950 text-[10px] font-semibold text-white border border-white/10">
                BG
              </div>
            </div>
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-[9px] md:text-[10px] text-slate-300">
                Mental Game Coach · 5 Fundamentals
              </span>
            </div>
          </a>
          ...
          <div className="flex items-center gap-2">
            <span className="hidden sm:inline-flex items-center gap-1.5 rounded-full bg-slate-900/90 px-2.5 py-1 text-[9px] text-slate-200 border border-white/10">
              <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
              <span>Available 24/7</span>
            </span>
            <a
              href="#start"
              className="inline-flex items-center gap-1.5 rounded-2xl bg-gradient-to-br from-purple-500 to-sky-400 px-3 py-1.5 text-[10px] md:text-xs font-medium text-white shadow-lg shadow-purple-500/40 hover:shadow-purple-400/60 hover:-translate-y-0.5 transition-all duration-200"
            >
