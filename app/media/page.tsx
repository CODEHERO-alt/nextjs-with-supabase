...
const LINKS = {
  youtube: "https://www.youtube.com/user/drbrettdenkin", // verified :contentReference[oaicite:1]{index=1}
  tiktok: "https://www.tiktok.com/@drbrettrodemodel_academy", // standard handle URL (could not verify due to robots)
  linkedin:
    "https://www.linkedin.com/search/results/all/?keywords=Dr.%20Brett%20Denkin", // swap with exact profile URL if you have it
  x: "https://x.com/drbrettdenkin", // verified :contentReference[oaicite:2]{index=2}
};
...
function PlatformIcon({
  ...
  // Simple inline SVG icons (no new deps)
  if (kind === "youtube") {
    return (
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-black/10 p-5 backdrop-blur-xl">
            ...
            <div className="mt-4 space-y-3 text-[13px] leading-6 text-slate-300">
              ...
              <p className="text-[12px] text-slate-300">
                People can submit anonymous voice recordings so patterns can be
                studied and turned into useful guidance.
              </p>
            </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/10 p-5 backdrop-blur-xl">
            ...
            <div className="mt-4 space-y-3 text-[13px] leading-6 text-slate-300">
              <p>
                This is a place to submit a situation, not start a conversation.
              </p>
              <p className="text-[12px] text-slate-300">
        ...
        <div className="mt-6 rounded-2xl border border-white/10 bg-black/10 p-5 backdrop-blur-xl">
          ...
          <p className="mt-3 max-w-4xl text-[13px] leading-7 text-slate-300">
            The media is public. BGPT is private. The same ideas you see here can
            be applied to your exact sport, role, and pressure points inside
